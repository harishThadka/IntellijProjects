...
public class StringConcepts {
    ...
    public static void main(String[] args) {
        ...
        String s2 = new String("Hi"); // Using new Keyword, new String object will be created in heap memory
        String s3 = new String("Hi").intern();
        String s4 = "Hi"; // both are same above line and this line


        String blank = "         ";
        System.out.println("Blank Test: "+blank.isBlank());
        System.out.println("Empty Test: "+blank.isEmpty()); // Checks length == 0
        System.out.println("Compare To: "+("a".compareTo("b"))); // a > b == -1
        ...
        System.out.println("s5 identity hashcode:"+System.identityHashCode(s4));
